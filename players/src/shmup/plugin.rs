...
impl Plugin for ShmupPlugin {
    fn build(&self, app: &mut App) {
        ...
        app.insert_resource(ClearColor(bg_color))
            ...
            .add_system(player_systems::player_enemy_bullets_collisions)
            .add_system(player_systems::player_bullets_enemy_bullets_collisions)
            .add_system(player_systems::player_bullets_enemies_collisions)
