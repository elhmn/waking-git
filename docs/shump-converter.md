...
| key | type | default | example | description |
| :------------: | :----------: | :----: | :--------: | ---------------------------------------------- |
| `id` | `string` | - | - |the entity id is mapped to a git blob object id. |
| `scene_id` | `string` | - | - | the scene the object belongs to |
| `name` | `string` | - | - | the object name, can be the blob file name |
| `type` | `string` | - | - | the entity type is used to know how to display the object |
| `color` | `string` | - | - | the color is another visual information, mapped to the language's color |
| `weapon` | `string` | - | - | type of weapon |
| `movement_pattern` | `string` | - | - | the movement pattern followed by the entity |
| `speed` | `float` | - | - | the object speed can be extracted from blob size, value between 0 and 1|
| `hp` | `float` | - | - | the entity hp, value between 0 and 1 |
| `shield` | `string` | - | - | wether or not the entity has a shield or not |
| `destructible` | bool | - | - | wether or not the entity has a shield or not |
